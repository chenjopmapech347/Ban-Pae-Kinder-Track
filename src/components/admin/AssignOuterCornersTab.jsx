...
export default function AssignOuterCornersTab() {
  ...
  function getEntriesForClass(cls) {
    ...
    if (!stored) {
      return cornerDefs.map(d => ({ key: d.key, dayTimes: {} }));
    }
      ...
      <div className="page-header mb-4">
        <div>
          ...
          <p className="text-xs text-muted" style={{ marginTop: '.25rem' }}>
            เลือกกิจกรรม กำหนด<strong>วันที่ใช้</strong>และ<strong>เวลา</strong>แยกแต่ละวัน — กิจกรรมเดียวกันใช้ได้หลายวัน เวลาต่างกันได้
          </p>
        </div>
        {selectedClass && (
          <div style={{
                  ...
                  {cornerDefs.map(def => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {checked && (
                          <div style={{ paddingTop: '.55rem', borderTop: '1px solid #bfdbfe' }}>
                            {/* Day toggles */}
                            <div style={{
                                ...
                                {activeDays.map(d => (
                                  <div key={d.key} style={{
                                    ...
                                    <span style={{
                                      ...
                                      color: '#1d4ed8', width: '30px', flexShrink: 0,
                                    }}>
                                      {d.label}
                                    </span>
                                    <input
                                      ...
                                      style={{
                                        ...
                                        borderRadius: '7px',
                                        border: `1.5px solid ${entryDayTimes[d.key] ? '#60a5fa' : '#bfdbfe'}`,
                                        fontSize: '.82em', fontFamily: 'inherit',
                                        outline: 'none', background: 'white', color: '#1d4ed8',
                                      }}
                                    />
                                  </div>
                                ))}
