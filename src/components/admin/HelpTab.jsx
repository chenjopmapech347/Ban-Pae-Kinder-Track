    ...
    content: [
      ...
      },
      {
        ...
        items: [
          ...
          '② ตั้งค่าระบบ → "🏖️ วันหยุดราชการ" → เพิ่มวันหยุดประจำปีใหม่',
    ...
    content: [
      {
        ...
        items: [
          ...
          { icon: '📈', title: 'รายงานสรุปผลการประเมินพัฒนาการ', desc: 'สรุปผลรายห้อง รายบุคคล พร้อมกราฟแท่ง' },
    ...
    content: [
      {
        ...
        items: [
          ...
          { icon: '🏖️', title: 'วันหยุดราชการ', desc: 'ตั้งวันหยุดราชการประจำปี ใช้คำนวณวันเรียนจริงในรายงาน' },
