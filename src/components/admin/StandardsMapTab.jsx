...
// ── ข้อมูลตารางแมป (จัดกลุ่มตาม 4 ด้าน หลักสูตร 2568) ─────────────────────
const MAP_ROWS = [
  ...
  // ─── 2. อารมณ์ จิตใจ และสังคม (รวม อารมณ์ + สังคม เดิม) ──────────────
  {
    ...
    evidence: ['บันทึกพฤติกรรมเด็ก', 'แผนการสอนด้านอารมณ์-สังคม', 'แบบสังเกตพฤติกรรม', 'ภาพถ่ายกิจกรรมกลุ่ม', 'แฟ้มสะสมผลงาน'],
  },

  // ─── 3. ความเป็นพลเมืองและความเป็นไทย (ด้านใหม่ แยกจากสังคม) ──────────
  {
    ...
    rows: [
      ...
      { dcy: { code: '5.2', desc: 'มีวินัย ดูแลสิ่งแวดล้อม มารยาทไทย' },
        ...
        onesqa: '1.5', std68: '1.7ข คุณธรรม-ความเป็นไทย-สิ่งแวดล้อม' },
    ],
    evidence: ['บันทึกพฤติกรรมคุณธรรม', 'กิจกรรมวัฒนธรรมไทย', 'บันทึกการทำความดี', 'ภาพถ่ายกิจกรรมจิตสาธารณะ'],
  },
